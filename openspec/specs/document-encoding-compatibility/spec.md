# document-encoding-compatibility Specification

## Purpose

Define which text encodings the app can open (BOM-marked Unicode forms, UTF-8, GB18030 with a plausibility gate), the fixed fallback order, and how saves normalize documents to UTF-8.
