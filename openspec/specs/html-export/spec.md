...
Define the requirements for exporting documents as a single self-contained HTML file with all assets inlined, so the file is portable and opens offline.
