# document-alert-localization Specification

## Purpose

Define that all document-level failure alerts (open, decode, save, export, print, Pandoc guidance, attachment failures) render their copy in the app language via the localization table, with no hard-coded strings in the document layer.
