...
Resolve `\ref{label}` inline references to auto-numbered figures, tables, and equations in the Read-mode preview, providing technical and academic documents with cross-referencing capabilities.
