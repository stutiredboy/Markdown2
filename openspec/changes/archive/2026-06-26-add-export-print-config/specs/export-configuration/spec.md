...
PDF export, Print, HTML export, and DOCX/EPUB conversion SHALL be mutually
exclusive: starting one while another is in progress SHALL be ignored. This
prevents concurrent file-generation operations from conflicting over save panels
or producing inconsistent output from a mid-edit document.
